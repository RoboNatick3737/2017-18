...
public class ModifiedPIDController extends PIDController
{
    ...
    public ModifiedPIDController(double kP, double kI, double kD, double errorThreshold, TimeMeasure minimumTimeGap, double minimumOutput, double maximumOutput, double decayRate)
    {
        super(kP, kI, kD, errorThreshold, minimumTimeGap, minimumOutput, maximumOutput);
