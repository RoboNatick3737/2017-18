...
public class ModifiedPIDController extends PIDController
{
    ...
    public ModifiedPIDController(double kP, double kI, double kD, double errorThreshold, TimeMeasure updateRate, double minimumOutput, double maximumOutput, double decayRate)
    {
        super(kP, kI, kD, errorThreshold, updateRate, minimumOutput, maximumOutput);
