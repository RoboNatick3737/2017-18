...
public class PIDController implements LimitedUpdateRateFunction
{
     ...
     */
    public TimeMeasure minimumTimeGap;
    @Override
     ...
     */
    public PIDController(double kP, double kI, double kD, double errorThreshold, TimeMeasure minimumTimeGap, double minimumOutput, double maximumOutput)
    {
        this.kP = kP;
        this.kI = kI;
        this.kD = kD;
    ...
    {
        return System.nanoTime() - lastCorrectionTime >= minimumTimeGap.durationIn(TimeMeasure.Units.NANOSECONDS);
    }
