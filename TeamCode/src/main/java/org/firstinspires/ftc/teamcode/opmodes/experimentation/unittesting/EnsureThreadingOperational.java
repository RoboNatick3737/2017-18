        ...
        ParallelTask task1 = new ParallelTask(this, "Task 1", log) {
            ...
            protected void onDoTask() throws InterruptedException {
                ...
                while (true) {
                    ...
                    i++;
                    EnhancedOpMode.instance.flow.pause (new TimeMeasure(TimeMeasure.Units.SECONDS, .2));
                }
            }
        };
        ...
        ParallelTask task2 = new ParallelTask(this, "Task 2", log) {
            ...
            protected void onDoTask() throws InterruptedException {
                ...
                while (true) {
                    ...
                    i++;
                    EnhancedOpMode.instance.flow.pause (new TimeMeasure(TimeMeasure.Units.SECONDS, .5));
                }
            }
        };
